...
def find_slide_timestamps(
    model: Gemini,
    chunks_dir: str,
    slide_timestamps_prompt: str = SLIDE_TIMESTAMPS_PROMPT,
):
...
def merge_timestamps(chunks_dir: str, chunk_seconds: int) -> list[dict]:
    ...
    the output generated by [find_slide_timestamps][slides_vqa.preprocess_video.find_slide_timestamps].
